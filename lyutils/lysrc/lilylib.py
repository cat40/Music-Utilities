...
# import __main__ TODO find what this means
import glob
import os
import re
import shutil
...
# reload (sys) # not sure why this is here. if it's still nessesary (not likley, judging by above comment referencing
# python 2.4), can use importlib.reload
# sys.setdefaultencoding ('utf-8') # also doesn't exist in python 3... probably not nessesary
# import codecs

# the following two lines are causing problems todo: figure out what they are supposed to do
# not likley to be nessesary in python 3 where unicode is universal
